...
/**
 * All PermissionsComponent Test
 */
class AllPermissionsComponentTest extends PHPUnit_Framework_TestSuite {

	public static function suite() {
		$suite = new CakeTestSuite('All PermissionsComponent plugin tests');
		$path = App::pluginPath('PermissionsComponent');
